...
function UserMenuDropdown() {
    ...
    return (
        <div className="p-2 max-h-40 absolute top-full right-0 z-20 border overflow-y-auto bg-white text-nowrap rounded-md shadow-xl scrollbar-thin flex flex-col">

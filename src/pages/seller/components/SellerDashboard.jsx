  ...
  return (
    <section className="mx-auto max-w-7xl">
      ...
      <div className="mt-2 flex flex-wrap justify-between sm:gap-4">
        {/* Recent Orders */}
        <RecentOrdersCard OrdersData={orders} redirectTo={"/seller-dashboard/orders"} />

        {/* Top Products */}
        <LeaderboardCard leaderboardData={topProducts} title={"Products"} redirectTo={"/seller-dashboard/products"} />
      </div>
    </section>
  )
}

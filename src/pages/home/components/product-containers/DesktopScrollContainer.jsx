...
const { id, name, salePrice, mrp, thumbnails = [], company } = product;
const thumbnail = thumbnails[0]?.url;

const isSale = salePrice && mrp > salePrice;
  ...
  >
    ...
    <div className="p-4 w-full aspect-square sm:h-3/4 relative overflow-hidden">
      ...
      <button
        ...
        className="p-1.5 w-3/4 text-white bg-black/80 font-semibold absolute left-1/2 bottom-0 transform -translate-x-1/2 translate-y-full group-hover:-translate-y-full transition-transform duration-300 rounded-2xl border"
      >
        Add to cart
      </button>
    </div>
